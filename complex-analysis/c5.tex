...
\section{Mittag-Leffler expansion}\label{c5s5}
...
Mittag-Leffler expansion allows us to construct series representation of functions.
As an example, let
\[
...
We now prove another theorem on meromorphic functions.
...
\begin{thm}[Fundamental theorem of algebra]\label{c5s5t3}
...
\section{Problems and examples}\label{c5s6}
\begin{enumerate}
